...
![Real `zenzic check all` output: Z402 exempted on archive/**, while a genuine broken link still fails the build](../../assets/images/blog/governance_exemption_demo.webp)
