...
| **Brand & Governance** | `zenzic check assets` | `Z620`, `Z404`–`Z406`, `Z601`, `Z603`, `Z610`–`Z616` | **25%** | 25 pts |
| **Content Excellence** | `zenzic check all` | `Z120`, `Z122`, `Z403`, `Z501`–`Z503`, `Z505`–`Z506`, `Z510`–`Z517` | **20%** | 20 pts |
