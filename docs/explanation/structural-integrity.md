...
| [`Z407`](../reference/finding-codes.md#z407) | `INVALID_ENGINE_PATTERN` | Engine config declares a pattern that cannot be parsed |
...
- [Scoring System](./scoring-system.md) — How the Documentation Quality Score is computed
