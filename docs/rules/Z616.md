---
title: "Z616 — Cross-Namespace Link Forbidden"
---
...
- :material-alert-circle:{ .lg .middle style="color: var(--zz-error);" } **Severity: Error**
    ...
    Penalty: **8.0 points** | Category: **`brand`**
...
The directive goes **at the end of the line the link is on**. `Z616` anchors to the
...
[Internal Secret Spec](../internal/secret.md) <!-- zenzic:ignore:Z616 -->
```
