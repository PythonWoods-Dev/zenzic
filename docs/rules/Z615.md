---
title: "Z615 — Forbidden URL Scheme"
---
...
The directive goes **at the end of the line the link is on**. `Z615` anchors to the
...
[FTP Mirror](ftp://archive.example.org/files) <!-- zenzic:ignore:Z615 -->
```
