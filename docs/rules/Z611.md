---
title: "Z611 — Forbidden Domain Reference"
---
...
The directive goes **at the end of the line the link is on**. `Z611` anchors to the
...
See the [legacy system](https://legacy.corp/docs) for historical context. <!-- zenzic:ignore:Z611 -->
```
