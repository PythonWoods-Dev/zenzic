...
| **Graph Topology** | `Z401`–`Z407` | Orphan pages, nav contract, config assets; `Z401` (missing directory index) is opt-in and informational | ✅ Yes | Deducts score / Exit 1 — `Z401` carries no penalty |
