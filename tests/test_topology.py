...
from zenzic.core.topology import detect_orphans, detect_dead_ends
from zenzic.models.vsm import VirtualSiteMap, Route

def test_detect_orphans():
    vsm = VirtualSiteMap()
    vsm["/index.html"] = Route(url="/index.html", source="index.md", status="REACHABLE", anchors=set())
    ...
    vsm["/orphan.html"] = Route(url="/orphan.html", source="orphan.md", status="REACHABLE", anchors=set())
...
def test_detect_dead_ends():
    ...
    vsm["/index.html"] = Route(url="/index.html", source="index.md", status="REACHABLE", anchors=set())
    vsm["/a.html"] = Route(url="/a.html", source="a.md", status="REACHABLE", anchors=set())
    vsm["/dead_end.html"] = Route(url="/dead_end.html", source="dead_end.md", status="REACHABLE", anchors=set())
    vsm["/asset.png"] = Route(url="/asset.png", source="asset.png", status="REACHABLE", anchors=set())
