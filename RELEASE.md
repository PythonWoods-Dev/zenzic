...
- [ ] `pyproject.toml` version matches the tag (`0.28.0`)
...
git tag -s -m "Release v0.28.0" v0.28.0
git push origin main --tags

```

- [ ] Create GitHub Release from the tag, using the `## [0.28.0]` CHANGELOG section as the release body.
