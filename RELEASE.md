...
- [ ] `pyproject.toml` version matches the tag (`0.27.2`)
...
git tag -s -m "Release v0.27.2" v0.27.2
git push origin main --tags

```

- [ ] Create GitHub Release from the tag, using the `## [0.27.2]` CHANGELOG section as the release body.
