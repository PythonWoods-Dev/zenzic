...
- [ ] `pyproject.toml` version matches the tag (`0.29.0`)
...
git tag -s -m "Release v0.29.0" v0.29.0
git push origin main --tags

```

- [ ] Create GitHub Release from the tag, using the `## [0.29.0]` CHANGELOG section as the release body.
