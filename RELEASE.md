...
- [ ] `pyproject.toml` version matches the tag (`0.28.1`)
...
git tag -s -m "Release v0.28.1" v0.28.1
git push origin main --tags

```

- [ ] Create GitHub Release from the tag, using the `## [0.28.1]` CHANGELOG section as the release body.
