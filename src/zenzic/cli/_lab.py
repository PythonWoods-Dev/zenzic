...
_GALLERY: dict[str, _Act] = {
    ...
    "z513": _Act(
        ...
        description="Z513 DUPLICATE_HEADING — duplicate heading found within the same document",
        example_dir="z513-duplicate-heading",
        expected_pass=False,
    ),
    "z514": _Act(
        code="z514",
        title="Generic Image Alt Text",
        description="Z514 GENERIC_IMAGE_ALT_TEXT — generic alt text detected ('image', 'screenshot', etc.)",
        example_dir="z514-generic-image-alt",
        expected_pass=False,
    ),
    "z515": _Act(
        code="z515",
        title="Bare URL Used",
        description="Z515 BARE_URL_USED — raw URL in prose not enclosed in angle brackets or Markdown link",
        example_dir="z515-bare-url",
        expected_pass=False,
    ),
    "z516": _Act(
        code="z516",
        title="Multiple H1 Headings",
        description="Z516 MULTIPLE_H1_HEADINGS — multiple H1 headings found in a single document; error, penalty 5.0",
        example_dir="z516-multiple-h1",
        expected_pass=False,
    ),
    "z517": _Act(
        code="z517",
        title="Heading Punctuation",
        description="Z517 HEADING_PUNCTUATION — heading ends with invalid punctuation (., :, ;)",
